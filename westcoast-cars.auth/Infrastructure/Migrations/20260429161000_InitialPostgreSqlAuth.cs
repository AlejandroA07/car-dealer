...
[Migration("20260429161000_InitialPostgreSqlAuth")]
public partial class InitialPostgreSqlAuth : Migration
{
    ...
    {
        migrationBuilder.DropTable("AspNetRoleClaims", schema: "auth");
        migrationBuilder.DropTable("AspNetUserClaims", schema: "auth");
        migrationBuilder.DropTable("AspNetUserLogins", schema: "auth");
        migrationBuilder.DropTable("AspNetUserRoles", schema: "auth");
        migrationBuilder.DropTable("AspNetUserTokens", schema: "auth");
        migrationBuilder.DropTable("AspNetRoles", schema: "auth");
        migrationBuilder.DropTable("AspNetUsers", schema: "auth");
    }
}
