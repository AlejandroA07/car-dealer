    ...
    public VehiclesController(WestcoastCarsContext context, IConfiguration config, IHttpClientFactory httpClient)
{
    ...
    public async Task<IActionResult> Delete(int id)
    {
        ...
        if(vehicle is null) return Content("Hittade inte bilen");
    ...
    /* [HttpGet("Update/{id}")]
    public async Task<IActionResult> Edit(int id){
        var vehicle = await _context.Vehicles.SingleOrDefaultAsync(c => c.Id == id);

        var vehicleToUpdate = new VehicleUpdateViewModel{
            Id = vehicle.Id,
    ...
    [HttpPut()]
    public async Task<IActionResult> Edit(VehicleUpdateViewModel vehicle){
        var vehicleToUpdate = await _context.Vehicles.SingleOrDefaultAsync(c => c.Id == vehicle.Id);
    ...
    [HttpPatch("Markassold/{id}")]
    public async Task<IActionResult> MarkAsSold(int id){
        var vehicleToUpdate = await _context.Vehicles.SingleOrDefaultAsync(c => c.Id == id);

        vehicleToUpdate.Sold = true;
